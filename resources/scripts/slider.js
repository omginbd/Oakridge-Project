jQuery(document).ready(function ($) {
    ...
    function ScaleSlider() {
        var parentWidth = jssor_slider1.$Elmt.parentNode.clientWidth,
            parentEle = $(".mainContent"),                    
            marginLeft = parseInt(parentEle.css("margin-left"), 10),
            marginRight = parseInt(parentEle.css("margin-right"), 10),
            paddingLeft = parseInt(parentEle.css("padding-left"), 10),
            paddingRight = parseInt(parentEle.css("padding-right"), 10),
